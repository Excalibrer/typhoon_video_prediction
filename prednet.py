...
class PredNet(Recurrent):
    ...
    # Arguments
        stack_sizes: number of channels in targets (A) and predictions (Ahat) in each layer of the architecture.
            ...
            correspond to a 3 layer architecture that takes in RGB images and has 16 and 32
        ...
        A_filt_sizes: filter sizes for the target (A) modules.
            ...
            targets for layers 2 and 3 are computed by a 3x3 convolution of the errors (E)
        ...
        Ahat_filt_sizes: filter sizes for the prediction (Ahat) modules.
            ...
            the predictions for each layer are computed by a 3x3 convolution of the
        ...
        output_mode: either 'error', 'prediction', 'all' or layer specification.
